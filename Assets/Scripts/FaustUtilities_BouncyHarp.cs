...
*/
namespace FaustUtilities_BouncyHarp {

	#if UNITY_EDITOR
    using UnityEditor;

	[CustomEditor(typeof(FaustPlugin_BouncyHarp))]
	public class FaustPlugin_Editor: Editor {

		// Initialization of the dsp
		private FaustPlugin_BouncyHarp _dsp;
		...
		private void OnEnable() {
			fJSON = "{	\"name\": \"Bouncy Harp\",	\"filename\": \"BouncyHarp.dsp\",	\"version\": \"2.40.12\",	\"compile_options\": \"-lang cpp -es 1 -mcd 16 -uim -single -ftz 0\",	\"library_list\": [\"/usr/local/share/faust/stdfaust.lib\",\"/usr/local/share/faust/signals.lib\",\"/usr/local/share/faust/reverbs.lib\",\"/usr/local/share/faust/maths.lib\",\"/usr/local/share/faust/platform.lib\",\"/usr/local/share/faust/delays.lib\",\"/usr/local/share/faust/basics.lib\",\"/usr/local/share/faust/filters.lib\",\"/usr/local/share/faust/routes.lib\",\"/usr/local/share/faust/noises.lib\"],	\"include_pathnames\": [\"/usr/local/share/faust\",\"/usr/local/share/faust\",\"/usr/share/faust\",\".\",\"/tmp/sessions/DBD0A3B1EB415F9B347350558FF54BD69068E118/unity/windows64/.\"],	\"inputs\": 0,	\"outputs\": 2,	\"meta\": [ 		{ \"author\": \"ER\" },		{ \"basics.lib/name\": \"Faust Basic Element Library\" },		{ \"basics.lib/version\": \"0.6\" },		{ \"compile_options\": \"-lang cpp -es 1 -mcd 16 -uim -single -ftz 0\" },		{ \"delays.lib/name\": \"Faust Delay Library\" },		{ \"delays.lib/version\": \"0.1\" },		{ \"filename\": \"BouncyHarp.dsp\" },		{ \"filters.lib/allpass_comb:author\": \"Julius O. Smith III\" },		{ \"filters.lib/allpass_comb:copyright\": \"Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>\" },		{ \"filters.lib/allpass_comb:license\": \"MIT-style STK-4.3 license\" },		{ \"filters.lib/ff_comb:author\": \"Julius O. Smith III\" },		{ \"filters.lib/ff_comb:copyright\": \"Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>\" },		{ \"filters.lib/ff_comb:license\": \"MIT-style STK-4.3 license\" },		{ \"filters.lib/levelfilter:author\": \"Julius O. Smith III\" },		{ \"filters.lib/levelfilter:copyright\": \"Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>\" },		{ \"filters.lib/levelfilter:license\": \"MIT-style STK-4.3 license\" },		{ \"filters.lib/lowpass0_highpass1\": \"MIT-style STK-4.3 license\" },		{ \"filters.lib/lowpass0_highpass1:author\": \"Julius O. Smith III\" },		{ \"filters.lib/lowpass:author\": \"Julius O. Smith III\" },		{ \"filters.lib/lowpass:copyright\": \"Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>\" },		{ \"filters.lib/lowpass:license\": \"MIT-style STK-4.3 license\" },		{ \"filters.lib/name\": \"Faust Filters Library\" },		{ \"filters.lib/tf1:author\": \"Julius O. Smith III\" },		{ \"filters.lib/tf1:copyright\": \"Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>\" },		{ \"filters.lib/tf1:license\": \"MIT-style STK-4.3 license\" },		{ \"filters.lib/tf1s:author\": \"Julius O. Smith III\" },		{ \"filters.lib/tf1s:copyright\": \"Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>\" },		{ \"filters.lib/tf1s:license\": \"MIT-style STK-4.3 license\" },		{ \"filters.lib/version\": \"0.3\" },		{ \"maths.lib/author\": \"GRAME\" },		{ \"maths.lib/copyright\": \"GRAME\" },		{ \"maths.lib/license\": \"LGPL with exception\" },		{ \"maths.lib/name\": \"Faust Math Library\" },		{ \"maths.lib/version\": \"2.5\" },		{ \"name\": \"Bouncy Harp\" },		{ \"noises.lib/name\": \"Faust Noise Generator Library\" },		{ \"noises.lib/version\": \"0.3\" },		{ \"platform.lib/name\": \"Generic Platform Library\" },		{ \"platform.lib/version\": \"0.2\" },		{ \"reverbs.lib/name\": \"Faust Reverb Library\" },		{ \"reverbs.lib/version\": \"0.2\" },		{ \"routes.lib/hadamard:author\": \"Remy Muller, revised by RM\" },		{ \"routes.lib/name\": \"Faust Signal Routing Library\" },		{ \"routes.lib/version\": \"0.2\" },		{ \"signals.lib/name\": \"Faust Signal Routing Library\" },		{ \"signals.lib/version\": \"0.1\" }	],	\"ui\": [ 		{			\"type\": \"vgroup\",			\"label\": \"BouncyHarp\",			\"items\": [ 				{					\"type\": \"vgroup\",					\"label\": \"BouncyHarp\",					\"items\": [ 						{							\"type\": \"hslider\",							\"label\": \"Instrument Hand (Loop mode: hand>0 = recording, 0 = playback)\",							\"shortname\": \"Instrument_Hand_Loop_mode_hand_0_recording_0_playback\",							\"address\": \"/BouncyHarp/BouncyHarp/Instrument_Hand__Loop_mode:_hand>0_=_recording__0_=_playback_\",							\"meta\": [								{ \"1\": \"\" },								{ \"acc\": \"1 0 -8 0 11\" }							],							\"init\": 0,							\"min\": 0,							\"max\": 15,							\"step\": 1						},						{							\"type\": \"hslider\",							\"label\": \"Hight\",							\"shortname\": \"Hight\",							\"address\": \"/BouncyHarp/BouncyHarp/Hight\",							\"meta\": [								{ \"2\": \"\" },								{ \"acc\": \"0 0 -10 0 10\" }							],							\"init\": 3,							\"min\": 1,							\"max\": 6,							\"step\": 0.1						},						{							\"type\": \"hslider\",							\"label\": \"Dry/Soft Strings\",							\"shortname\": \"Soft_Strings\",							\"address\": \"/BouncyHarp/BouncyHarp/Dry/Soft_Strings\",							\"meta\": [								{ \"3\": \"\" },								{ \"acc\": \"2 1 -10 0 10\" }							],							\"init\": 0.45,							\"min\": 0,							\"max\": 0.9,							\"step\": 0.1						},						{							\"type\": \"hslider\",							\"label\": \"Picking Position\",							\"shortname\": \"Picking_Position\",							\"address\": \"/BouncyHarp/BouncyHarp/Picking_Position\",							\"meta\": [								{ \"4\": \"\" },								{ \"acc\": \"2 1 -10 0 10\" }							],							\"init\": 0.13,							\"min\": 0.02,							\"max\": 0.5,							\"step\": 0.01						},						{							\"type\": \"hslider\",							\"label\": \"Resonance (InstrReverb)\",							\"shortname\": \"Resonance_InstrReverb\",							\"address\": \"/BouncyHarp/BouncyHarp/Resonance__InstrReverb_\",							\"meta\": [								{ \"5\": \"\" },								{ \"acc\": \"1 1 -10 0 10\" }							],							\"init\": 5,							\"min\": 0.5,							\"max\": 10,							\"step\": 0.01						},						{							\"type\": \"checkbox\",							\"label\": \"Loop Mode ON/OFF (max 20s)\",							\"shortname\": \"OFF_max_20s\",							\"address\": \"/BouncyHarp/BouncyHarp/Loop_Mode_ON/OFF__max_20s_\",							\"meta\": [								{ \"7\": \"\" }							]						},						{							\"type\": \"vgroup\",							\"label\": \"Reverb\",							\"meta\": [								{ \"8\": \"\" }							],							\"items\": [ 								{									\"type\": \"hslider\",									\"label\": \"Reverberation Volume (InstrReverb)\",									\"shortname\": \"Reverberation_Volume_InstrReverb\",									\"address\": \"/BouncyHarp/BouncyHarp/Reverb/Reverberation_Volume__InstrReverb_\",									\"meta\": [										{ \"acc\": \"1 1 -10 20 0 0.5\" }									],									\"init\": 0.5,									\"min\": 0.1,									\"max\": 1,									\"step\": 0.01								},								{									\"type\": \"hslider\",									\"label\": \"ÒReverberation Room Size (InstrReverb)\",									\"shortname\": \"_Reverberation_Room_Size_InstrReverb\",									\"address\": \"/BouncyHarp/BouncyHarp/Reverb/ÒReverberation_Room_Size__InstrReverb_\",									\"meta\": [										{ \"acc\": \"1 1 -10 0 25\" }									],									\"init\": 0.72,									\"min\": 0.01,									\"max\": 2,									\"step\": 0.01								}							]						}					]				}			]		}	]}";
			...
			_dsp = (FaustPlugin_BouncyHarp) target;          // Sets which component will be edited in the inspector
		}
	...
	*/
	public class Faust_Context {
		...
		const string _dllName = "libFaustPlugin_BouncyHarp";
		#elif UNITY_IOS
		const string _dllName = "__Internal";
		#elif UNITY_EDITOR || UNITY_ANDROID || UNITY_STANDALONE_LINUX
		const string _dllName = "FaustPlugin_BouncyHarp";
		#else
