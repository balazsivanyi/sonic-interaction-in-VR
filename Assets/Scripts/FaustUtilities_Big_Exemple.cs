...
*/
namespace FaustUtilities_Big_Exemple {

	#if UNITY_EDITOR
    using UnityEditor;

	[CustomEditor(typeof(FaustPlugin_Big_Exemple))]
	public class FaustPlugin_Editor: Editor {

		// Initialization of the dsp
		private FaustPlugin_Big_Exemple _dsp;
		...
		private void OnEnable() {
			fJSON = "{	\"name\": \"Three Rack Tuned Bars\",	\"filename\": \"Big_Exemple.dsp\",	\"version\": \"2.40.12\",	\"compile_options\": \"-lang cpp -es 1 -mcd 16 -uim -single -ftz 0\",	\"library_list\": [\"/usr/local/share/faust/stdfaust.lib\",\"/usr/local/share/faust/basics.lib\",\"/usr/local/share/faust/maths.lib\",\"/usr/local/share/faust/platform.lib\",\"/usr/local/share/faust/delays.lib\",\"/usr/local/share/faust/instruments.lib\",\"/usr/local/share/faust/filters.lib\"],	\"include_pathnames\": [\"/usr/local/share/faust\",\"/usr/local/share/faust\",\"/usr/share/faust\",\".\",\"/tmp/sessions/E5CB5665CC10D4C3B4E6C63730CCAC63A7BB5300/unity/windows64/.\"],	\"inputs\": 0,	\"outputs\": 2,	\"meta\": [ 		{ \"author\": \"ER\" },		{ \"basics.lib/name\": \"Faust Basic Element Library\" },		{ \"basics.lib/version\": \"0.6\" },		{ \"compile_options\": \"-lang cpp -es 1 -mcd 16 -uim -single -ftz 0\" },		{ \"delays.lib/name\": \"Faust Delay Library\" },		{ \"delays.lib/version\": \"0.1\" },		{ \"filename\": \"Big_Exemple.dsp\" },		{ \"filters.lib/lowpass0_highpass1\": \"MIT-style STK-4.3 license\" },		{ \"filters.lib/name\": \"Faust Filters Library\" },		{ \"filters.lib/version\": \"0.3\" },		{ \"instruments.lib/author\": \"Romain Michon (rmichon@ccrma.stanford.edu)\" },		{ \"instruments.lib/copyright\": \"Romain Michon\" },		{ \"instruments.lib/licence\": \"STK-4.3\" },		{ \"instruments.lib/name\": \"Faust-STK Tools Library\" },		{ \"instruments.lib/version\": \"1.0\" },		{ \"maths.lib/author\": \"GRAME\" },		{ \"maths.lib/copyright\": \"GRAME\" },		{ \"maths.lib/license\": \"LGPL with exception\" },		{ \"maths.lib/name\": \"Faust Math Library\" },		{ \"maths.lib/version\": \"2.5\" },		{ \"name\": \"Three Rack Tuned Bars\" },		{ \"platform.lib/name\": \"Generic Platform Library\" },		{ \"platform.lib/version\": \"0.2\" }	],	\"ui\": [ 		{			\"type\": \"vgroup\",			\"label\": \"Big_Exemple\",			\"items\": [ 				{					\"type\": \"vgroup\",					\"label\": \"STunedBar3\",					\"items\": [ 						{							\"type\": \"vgroup\",							\"label\": \"tunedBars\",							\"items\": [ 								{									\"type\": \"hgroup\",									\"label\": \"0x00\",									\"meta\": [										{ \"1\": \"\" }									],									\"items\": [ 										{											\"type\": \"hgroup\",											\"label\": \"bar 0\",											\"items\": [ 												{													\"type\": \"vslider\",													\"label\": \"Instrument Hand 0\",													\"shortname\": \"Instrument_Hand_0\",													\"address\": \"/Big_Exemple/STunedBar3/tunedBars/0x00/bar_0/Instrument_Hand_0\",													\"meta\": [														{ \"acc\": \"1 0 -10 0 14\" }													],													\"init\": 0,													\"min\": 0,													\"max\": 5,													\"step\": 1												}											]										},										{											\"type\": \"hgroup\",											\"label\": \"bar 1\",											\"items\": [ 												{													\"type\": \"vslider\",													\"label\": \"Instrument Hand 1\",													\"shortname\": \"Instrument_Hand_1\",													\"address\": \"/Big_Exemple/STunedBar3/tunedBars/0x00/bar_1/Instrument_Hand_1\",													\"meta\": [														{ \"acc\": \"1 0 -10 0 14\" }													],													\"init\": 2,													\"min\": 0,													\"max\": 5,													\"step\": 1												}											]										},										{											\"type\": \"hgroup\",											\"label\": \"bar 2\",											\"items\": [ 												{													\"type\": \"vslider\",													\"label\": \"Instrument Hand 2\",													\"shortname\": \"Instrument_Hand_2\",													\"address\": \"/Big_Exemple/STunedBar3/tunedBars/0x00/bar_2/Instrument_Hand_2\",													\"meta\": [														{ \"acc\": \"1 0 -10 0 10\" }													],													\"init\": 4,													\"min\": 0,													\"max\": 5,													\"step\": 1												}											]										}									]								}							]						}					]				}			]		}	]}";
			...
			_dsp = (FaustPlugin_Big_Exemple) target;          // Sets which component will be edited in the inspector
		}
	...
	*/
	public class Faust_Context {
		...
		const string _dllName = "libFaustPlugin_Big_Exemple";
		#elif UNITY_IOS
		const string _dllName = "__Internal";
		#elif UNITY_EDITOR || UNITY_ANDROID || UNITY_STANDALONE_LINUX
		const string _dllName = "FaustPlugin_Big_Exemple";
		#else
